...
// Deprecated: SQL learning system removed in favor of in-context learning (error-fix pairs in MCP)
export async function getLearningStats(_req: Request, res: Response): Promise<void> {
  res.json({ deprecated: true, message: 'SQL learning system has been replaced by in-context learning' });
}

export async function getLearningReport(_req: Request, res: Response): Promise<void> {
  res.json({ deprecated: true, message: 'SQL learning system has been replaced by in-context learning' });
}

export async function triggerLearning(_req: Request, res: Response): Promise<void> {
  res.json({ deprecated: true, message: 'SQL learning system has been replaced by in-context learning' });
}
